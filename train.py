...
parser.add_argument('--hidden_units', type = list, default = [8192,1024,512], help = 'An intger array for the hidden units')
...
#Label Maping
cat_to_name =  functionsRef.cat_to_name('cat_to_name.json')

#checking arch


#Bulding the model
model, criterion, optimizer = functionsRef.make_model(arguments.device,arch,25088,arguments.hidden_units,102,0.5,arguments.learning_rate)
